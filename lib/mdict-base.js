...
var MDictBase = /*#__PURE__*/function () {
  ...
  function MDictBase(fname, passcode) {
    ...
    this._whetherKeyCaseSensitive = config.keyCaseSensitive || _common["default"].isTrue(this.header.keyCaseSensitive);
    this._whetherStripKey = config.stripKey || _common["default"].isTrue(this.header.StripKey); // -------------------------
  ...
  (0, _createClass2["default"])(MDictBase, [{
    ...
    value: function _keyToBuffer() {
      ...
      var ruleKeyFn = function () {
        ...
        console.log('keycasesensitive:', _this._whetherKeyCaseSensitive, _this.header.KeyCaseSensitive);
