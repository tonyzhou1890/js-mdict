...
var _wordMapBuffer = require("./wordMapBuffer");
...
var MDictBase = /*#__PURE__*/function () {
  ...
  function MDictBase(fname, passcode, mode) {
    ...
    if (this.ext === 'mdx' && this.mode === 'mixed') {
      ...
      this.keyMap = new _wordMapBuffer.WordMapBuffer();
      ...
      _utils["default"].measureTime('decodeKeyBlock', this._decodeKeyBlock.bind(this)); // this._decodeKeyBlock(true);
  ...
  (0, _createClass2["default"])(MDictBase, [{
    ...
    value: function _decodeKeyBlock(keep) {
      ...
      for (var idx = 0; idx < this.keyBlockInfoList.length; idx++) {
        ...
        keyCount += this._splitKeyBlock(new _bl["default"](key_block));
    ...
    value: function _splitKeyBlock(keyBlock, needList) {
      ...
      while (keyStartIndex < keyBlock.length) {
        ...
        if (this.ext === 'mdx' && this.mode === 'mixed') {
          ...
          var key = (keyText !== null && keyText !== void 0 ? keyText : '').replace(regexp, '$1').toLowerCase();
