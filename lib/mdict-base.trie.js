...
var MDictBase = /*#__PURE__*/function () {
  ...
  function MDictBase(fname, passcode, mode) {
    ...
    if (this.ext === 'mdx' && this.mode === 'mixed') {
      _utils["default"].consoleMem('pre trie');
      ...
      this.trie = new _trie.Trie();

      _utils["default"].measureTime('_buildTrie', this._buildTrie.bind(this), this.keyList); // this._buildTrie(this.keyList)


      _utils["default"].consoleMem('after trie');
