...
var Mdict = /*#__PURE__*/function (_MdictBase) {
  ...
  function Mdict(fname) {
    ...
    var passcode = (_searchOptions$passco = searchOptions.passcode) !== null && _searchOptions$passco !== void 0 ? _searchOptions$passco : undefined;
    _this = _super.call(this, fname, passcode, searchOptions);
    _this.searchOptions = {};
  ...
  (0, _createClass2["default"])(Mdict, [{
    ...
    value: function isExist(key) {
      ...
      var record = this._lookupKID(key);
    ...
    key: "_lookupMdx",
    value: function _lookupMdx(key) {
      var record = this.keyBuffer.lookupByStr(key); // if not found, return
      ...
      var rid = this._reduceRecordBlock(record.recordStartOffset);

      var nextStart = record.nextRecordStartOffset || this._recordBlockStartOffset + this.recordBlockInfoList[this.recordBlockInfoList.length - 1].decompAccumulator + this.recordBlockInfoList[this.recordBlockInfoList.length - 1].decompSize;
      record = this._decodeRecordBlockByRBID(rid, record.keyText, record.recordStartOffset, nextStart);
      return record;
    }
  }, {
    key: "_isKeyCaseSensitive",
    value: function _isKeyCaseSensitive() {
      var _this$searchOptions$k;

      return (_this$searchOptions$k = this.searchOptions.keyCaseSensitive) !== null && _this$searchOptions$k !== void 0 ? _this$searchOptions$k : _common["default"].isTrue(this.header.KeyCaseSensitive);
    }
  }, {
