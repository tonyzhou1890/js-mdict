...
var Mdict = /*#__PURE__*/function (_MdictBase) {
  ...
  (0, _createClass2["default"])(Mdict, [{
    ...
    key: "isExist",
    value: function isExist(word) {
      // mdx 的 mixed 模式返回 stripKey 并且 lowercase 的所有单词列表
      if (this.ext === 'mdx' && this.mode === 'mixed') {
        var _this$keyMap$lookup;

        var recordList = [];
        var regexp = _common["default"].REGEXP_STRIPKEY[this.ext];
        var key = (word !== null && word !== void 0 ? word : '').replace(regexp, '$1').toLowerCase();
        recordList = (_this$keyMap$lookup = this.keyMap.lookup(key)) !== null && _this$keyMap$lookup !== void 0 ? _this$keyMap$lookup : [];
    ...
    value: function _lookupMixed(word) {
      var _this$keyMap$lookup2;

      var recordList = [];
      var regexp = _common["default"].REGEXP_STRIPKEY[this.ext];
      var key = (word !== null && word !== void 0 ? word : '').replace(regexp, '$1').toLowerCase();
      recordList = (_this$keyMap$lookup2 = this.keyMap.lookup(key)) !== null && _this$keyMap$lookup2 !== void 0 ? _this$keyMap$lookup2 : []; // if not found the key block, return undefined
